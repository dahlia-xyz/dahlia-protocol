...
contract OracleFactory {
    event ChainlinkOracleCreated(address indexed oracleAddress, ChainlinkWithMaxDelay.Params params, ChainlinkWithMaxDelay.Delays maxDelays);
    ...
    function createChainlinkOracle(ChainlinkWithMaxDelay.Params memory params, ChainlinkWithMaxDelay.Delays memory maxDelays)
        external
    ...
    function createUniswapOracle(UniswapV3SingleTwap.OracleParams memory params) external returns (UniswapV3SingleTwap) {
