...
contract DahliaProvider is IDahliaProvider {
    event IncentivizedVaultCreated(WrappedVault indexed vault, Types.MarketId indexed marketId);
    ...
    function onMarketDeployed(Types.MarketId id, IERC4626 marketProxy, address sender, bytes calldata) external {
        ...
        WrappedVault roycoIncentivizedVault = roycoFactory.wrapVault(marketProxy, sender, marketProxy.name(), fee);
